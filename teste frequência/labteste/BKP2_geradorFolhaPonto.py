...
def inicializar_programa():
    ...
    Retorna (ANO_REFERENCIA, MES_REFERENCIA, df_parametros) se tudo estiver OK, caso contrário retorna None.
    """
    ...
    #mostra a plailha.......:print(df_parametros)
    ...
    return ANO_REFERENCIA, MES_REFERENCIA, df_parametros
...
def processamento_central():
    ...
    ano, mes, df_parametros = resultado
